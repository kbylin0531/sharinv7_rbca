...
//        '__APP_IMAGES__'     => OSS_URL.trim(TMPL_PATH,'.').'App/Public/images',
        ...
        '__ADMIN_CSS__'      => SR_PUBLIC_URL.'/app/admin/admin/css',
        '__ADMIN_JS__'       => SR_PUBLIC_URL.'/app/admin/admin/js',
        '__ADMIN_IMAGES__'   => SR_PUBLIC_URL.'/app/admin/admin/images',
        '__PUBLIC_CSS__'     => SR_PUBLIC_URL.'/app/admin/public/css',
        '__PUBLIC_JS__'      => SR_PUBLIC_URL.'/app/admin/public/js',
        '__PUBLIC_IMAGES__'  => SR_PUBLIC_URL.'/app/admin/public/images',
        '__USER_CSS__'       => SR_PUBLIC_URL.'/app/admin/user/css',
        '__USER_JS__'        => SR_PUBLIC_URL.'/app/admin/user/js',
        '__USER_IMAGES__'    => SR_PUBLIC_URL.'/app/admin/user/images',
        '__APP_CSS__'        => SR_PUBLIC_URL.'/app/admin/App/Public/css',
        '__APP_JS__'         => SR_PUBLIC_URL.'/app/admin/App/Public/js',
        '__APP_IMAGES__'     => SR_PUBLIC_URL.'/app/admin/App/Public/images',

        '__ADMIN_ACEADMIN__' => SR_PUBLIC_URL.'/app/admin/admin/aceadmin',
    ),
//***********************************URL设置**************************************
