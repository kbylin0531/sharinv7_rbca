define("app/src/setting/main", ["lib/jquery-lib", "lib/util", "lib/artDialog/jquery-artDialog", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "./setting", "./fav", "./group", "./member", "./system"], function (e) {
    ...
    var e, t = function (e) {
        ...
        ("" == t || void 0 == t) && (t = "user"), e = t, "fav&" == t.substring(0, 4) && (t = "fav"), $(".selected").removeClass("selected"), $("ul.setting li#" + t).addClass("selected"), window.location.href = "#" + t, $.ajax({
            url: "./explorer.php?setting/slider&slider=" + t,
            beforeSend: function () {
        ...
        G.is_root ? $("ul.setting #system").show() : $("ul.setting #system").hide(), G.is_root || 1 == AUTH["member:get"] ? $("ul.setting #member").show() : $("ul.setting #member").hide(), e = location.hash.split("#", 2)[1], i(e), $("ul.setting li").hover(function () {
            ...
            var n = "explorer.php?setting/set&k=" + type + "&v=" + value;
            $.ajax({
        ...
        switch (e) {
            case"user":
                ...
                $.ajax({
                    url: "explorer.php?user/changePassword&password_now=" + t + "&password_new=" + a,
                    dataType: "json",
                    success: function (e) {
                        tips(e), e.code && (window.top.location.href = "./explorer.php?user/logout")
                    }
                });
                break;
            case"wall":
                ...
                var n = "explorer.php?setting/set&k=wall&v=" + urlEncode(i);
                $.ajax({
                    url: n, type: "json", success: function (e) {
                        tips(e)
                    }
    ...
    var e = "explorer.php?fav/", t = function (t) {
        var a;
        $.ajax({
    ...
    var e = "explorer.php?group/", t = {}, a = function () {
        $.ajax({
            url: e + "get", dataType: "json", async: !1, success: function (e) {
    ...
    var e, t = "explorer.php?member/", a = "", i = {}, n = function () {
    ...
    var e = function () {
        $("input[name='first_in']").live("click", function () {
            ...
            art.dialog.open("./explorer.php?setting/php_info", {
                title: "php_info",
                width: "70%",
                height: "65%",
                resize: !0
        ...
        $.ajax({
            url: "explorer.php?setting/system_setting",
            type: "POST",
