define("app/src/explorer_wap/main", ["lib/jquery-lib", "lib/util", "lib/artDialog/jquery-artDialog", "./ui", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "./path", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer"], function (e) {
    ...
    this._getFolderBoxList = function (e) {
        ...
        if ("number" == typeof e.exists && 0 == e.exists && (a = '<b style="color:red;">' + a + "</b>"), "oexe" == e.ext) {
            ...
            var n = core.path2url(G.this_path + e.name), o = "explorer.php?explorer/image&path=" + urlEncode(G.this_path + e.name);
                ...
                $(".right_tool").on("click", function () {
                    ...
                    switch (e) {
                        ...
                        case"public":
                            ...
                            break;
                        case"exit":
                            window.location.href = "./explorer.php?user/logout";
                            break;
                        default:
                    }
    ...
    return {
        filetype: {
            ...
            $("#" + n + " .remove").bind("click", function () {
                clearInterval(s), s = !1, clearTimeout(r), s = !1, $.get("./explorer.php?explorer/serverDownload&type=remove&uuid=" + n), $(this).parent().parent().slideUp(function () {
                    $(this).remove(), ui.f5()
                })
            }), $.ajax({
    ...
    var n = function (e, t, a) {
        if (void 0 != e) {
            ...
            G.this_path = e.replace(/\\/g, "/"), G.this_path = e.replace(/\/+/g, "/"), "/" != G.this_path.substr(G.this_path.length - 1) && (G.this_path += "/"), window.location.href = "explorer.php#" + G.this_path, ui.f5_callback(function () {
                "function" == typeof a && a()
            })
        }
    }, o = function (e, t) {
        if (void 0 != e) {
            ...
            if (inArray(core.filetype.image, t) || inArray(i, t) || inArray(core.filetype.text, t) || inArray(core.filetype.code, t))window.location.href = a; else {
                var n = "explorer.php?explorer/fileDownload&path=" + urlEncode2(e), o = '<div class="unknow_file" style="width:200px;word-break: break-all;"><span>' + LNG.unknow_file_tips + "<br/>" + '</span><br/><a class="btn btn-success btn-sm" href="' + n + '"> ' + LNG.unknow_file_download + " </a></div>";
                $.dialog({
                    fixed: !0,
                    icon: "warning",
                    width: 30,
    ...
    var a = ["/", "\\", ":", "*", "?", '"', "<", ">", "|"], i = function (e) {
        ...
        if (!(1 > e.length)) {
            var a = e[0].path, i = LNG.remove_title, o = a + "<br/><br/>" + LNG.remove_info, s = "explorer.php?explorer/pathDelete";
            "*recycle*/" == G.this_path && (o = LNG.recycle_remove + "?", s = "explorer.php?explorer/pathDeleteRecycle", i = LNG.recycle_remove), "share" == e[0].type && (o = LNG.share_remove_tips, s = "explorer.php?userShare/del", i = LNG.share_remove), e.length > 1 && (o += ' ... <span class="badge">' + e.length + "</span>"), $.dialog({
        ...
        if (!(1 > e.length)) {
            ...
            $.ajax({
                url: "./explorer.php?explorer/mkfile&path=" + s,
                type: "POST",
                dataType: "json",
                ...
                name: LNG.button_save, focus: !0, callback: function () {
                    ...
                    switch (i) {
                        case"user_add":
                            ...
                            o = "./explorer.php?app/user_app&action=add&path=" + s;
                            break;
                        case"user_edit":
                            o = "./explorer.php?app/user_app&path=" + urlEncode2(t.path);
                            break;
                        case"root_add":
                            o = "./explorer.php?app/add&name=" + e.name;
                            break;
                        case"root_edit":
                            o = "./explorer.php?app/edit&name=" + e.name + "&old_name=" + t.name;
                            break;
                        default:
                    }
                    $.ajax({
