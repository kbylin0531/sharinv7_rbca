...
define("app/src/edit/main", ["lib/jquery-lib", "lib/util", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "./function_list", "./taskTap", "./toolbar", "./edit", "./mode", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html"], function (e) {
    ...
    var s = function (e, t) {
        ...
        var s = "./explorer.php?editor/fileGet&filename=" + e;
        G.share_page !== void 0 && (s = "./explorer.php?share/fileGet&user=" + G.user + "&sid=" + G.sid + "&filename=" + e), t = {
            charset: "utf-8",
            uuid: i,
        ...
        o && $.ajax({
            url: "./explorer.php?editor/setConfig&k=" + o.k + "&v=" + o.v,
            dataType: "json",
            success: function () {
            }
        })
        ...
        if (void 0 != i) {
            ...
            if (n.hasChanged) {
                ...
                var r = "./explorer.php?editor/fileSave";
                G.share_page !== void 0 && (r = "./explorer.php?share/fileSave&user=" + G.user + "&sid=" + G.sid + "&filename=" + o), $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: r,
