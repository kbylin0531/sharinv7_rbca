define("app/src/app/main", ["lib/jquery-lib", "lib/util", "lib/artDialog/jquery-artDialog", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "./page"], function (e) {
    ...
    var e, a = function () {
        e = location.hash.split("#", 2)[1], e || (e = "all"), i(e), $("ul.setting li").hover(function () {
            ...
            var e = "explorer.php?setting/set&k=" + type + "&v=" + value;
            $.ajax({
            ...
            if ($(e.target).attr("action")) {
                ...
                switch (t) {
                    ...
                    case"add":
                        ...
                        var n = share.data("create_app_path"), o = urlEncode(n + a.name), s = "./explorer.php?app/user_app&action=add&path=" + o;
                        $.ajax({
                            url: s,
                            dataType: "json",
                            type: "POST",
                    ...
                    case"del":
                        $.ajax({
                            url: "./explorer.php?app/del&name=" + urlEncode(a.name),
                            dataType: "json",
                            error: core.ajaxError,
                            success: function (e) {
        ...
        var i = $(".main .app-list");
        $.ajax({
            url: "./explorer.php?app/get&group=" + a, dataType: "json", beforeSend: function () {
            }, success: function (e) {
