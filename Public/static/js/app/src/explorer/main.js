define("app/src/explorer/main", ["lib/jquery-lib", "lib/util", "lib/ztree/js/ztree", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "lib/picasa/picasa", "./ui", "./fileSelect", "../../common/taskTap", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../common/rightMenu", "../../common/tree", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer", "./path"], function (e) {
    Config = {
        ...
        TreeId: "folderList",
        pageApp: "explorer",
        treeAjaxURL: "explorer.php?explorer/treeList&app=explorer",
        AnimateTime: 200
    }, Global = {
        fileListAll: "",
        fileListNum: 0,
    ...
    var _ajaxLive = function () {
        ...
        G.list_type = e, void 0 == t ? $.ajax({
            url: "explorer.php?setting/set&k=list_type&v=" + e,
            dataType: "json",
            success: function () {
        ...
        0 != e && (G.sort_field = e, $(".menu_set_sort").removeClass("selected"), $(".set_sort_" + e).addClass("selected")), 0 != t && (G.sort_order = t, $(".menu_set_desc").removeClass("selected"), $(".set_sort_" + t).addClass("selected")), _f5(!1, !0), $.ajax({url: "explorer.php?setting/set&k=list_sort_field,list_sort_order&v=" + G.sort_field + "," + G.sort_order})
        ...
        $(".dropdown-menu-theme li").click(function () {
            ...
            $.ajax({
                url: "explorer.php?setting/set&k=theme&v=" + e, dataType: "json", success: function (t) {
    ...
    this._hover_title = function (e) {
        ...
        if ("number" == typeof e.exists && 0 == e.exists && (a = '<b style="color:red;">' + a + "</b>"), "oexe" == e.ext) {
            ...
            var n = core.path2url(G.this_path + e.name), s = "explorer.php?explorer/image&path=" + urlEncode(G.this_path + e.name);
    ...
    var pathTypeChange = function () {
        ...
        if (void 0 == e && (e = !0), void 0 == t && (t = !1), _jsonSortTitle(), e)$.ajax({
            url: "explorer.php?explorer/pathList&path=" + urlEncode(G.this_path),
            dataType: "json",
            beforeSend: function () {
    ...
    return {
        filetype: {
            ...
            var t = G.app_host + "/explorer.php?explorer/fileProxy&path=" + urlEncode(e);
            return G.share_page !== void 0 && (t = G.app_host + "/explorer.php?share/fileProxy&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode(e)), t
            ...
            var a = "./explorer.php?editor/fileGet&filename=" + urlEncode2(e);
            G.share_page !== void 0 && (a = "./explorer.php?share/fileGet&user=" + G.user + "&sid=" + G.sid + "&filename=" + urlEncode2(e)), $.ajax({
                url: a,
                dataType: "json",
                beforeSend: function () {
            ...
            void 0 == e && (e = G.is_root ? "system" : "user"), void 0 == window.top.frames.Opensetting_mode ? $.dialog.open("./explorer.php?setting#" + e, {
                id: "setting_mode",
                fixed: !0,
            ...
            var a = "./explorer.php?/explorer&type=iframe&path=" + e;
            G.share_page !== void 0 && (a = "./explorer.php?share/folder&type=iframe&user=" + G.user + "&sid=" + G.sid + "&path=" + e), $.dialog.open(a, {
                resize: !0,
                fixed: !0,
                ico: core.ico("folder"),
                title: t,
            ...
            void 0 == e && (e = "");
            var t = "explorer.php?/editor&project=" + e;
            G.share_page !== void 0 && (t = "./explorer.php?share/code_read&user=" + G.user + "&sid=" + G.sid + "&project=" + e), $.dialog.open(t, {
                resize: !0,
                fixed: !0,
                ico: core.ico("folder"),
            ...
            var a, i, n = require("../tpl/search.html"), s = require("../tpl/search_list.html"), o = function () {
                ...
                var i = "explorer.php?explorer/search";
                G.share_page !== void 0 && (i = "explorer.php?share/search&user=" + G.user + "&sid=" + G.sid), $.ajax({
                    url: i,
                    dataType: "json",
                    type: "POST",
                    data: e,
            ...
            $("#" + n + " .remove").bind("click", function () {
                clearInterval(o), o = !1, clearTimeout(r), o = !1, $.get("./explorer.php?explorer/serverDownload&type=remove&uuid=" + n), $(this).parent().parent().slideUp(function () {
                    $(this).remove(), ui.f5()
                })
            }), $.ajax({
                url: "./explorer.php?explorer/serverDownload&type=download&save_path=" + e + "&url=" + urlEncode2(i) + "&uuid=" + n,
                dataType: "json",
                error: function (e, t, a) {
            ...
            var h = function () {
                $.ajax({
                    url: "./explorer.php?explorer/serverDownload&type=percent&uuid=" + n,
                    dataType: "json",
                    success: function (e) {
                        var t = "", a = e.data;
                        if (o) {
            ...
            if (uploader.option("server", "explorer.php?explorer/fileUpload&path=" + urlEncode(G.upload_path)), 30 >= e.length ? e : "..." + e.substr(e.length - 30), 0 != $(".dialog_file_upload").length)return $.dialog.list.dialog_file_upload.display(!0), void 0;
    ...
    return {
        pathOpen: i, init: r, refresh: p, openEditor: function () {
            ...
            $.dialog({
                ...
                ok: function () {
                    $.ajax({
                        url: "explorer.php?fav/del&name=" + d().node.name,
                        dataType: "json",
                        async: !1,
                        success: function (e) {
            ...
            var e = "./explorer.php?share/file&sid=" + G.sid + "&user=" + G.user + "&path=" + d().path;
            window.open(e)
        }, rname: function () {
    ...
    var a = ["/", "\\", ":", "*", "?", '"', "<", ">", "|"], i = function (e) {
        ...
        if (e) {
            ...
            return i(a) ? ($.ajax({
                dataType: "json",
                url: "explorer.php?explorer/mkfile&path=" + urlEncode2(e),
                beforeSend: function () {
                    core.tips.loading()
                },
                error: core.ajaxError,
        ...
        if (e) {
            ...
            return i(a) ? ($.ajax({
                dataType: "json",
                url: "explorer.php?explorer/mkdir&path=" + urlEncode2(e),
                beforeSend: function () {
                    core.tips.loading()
                },
                error: core.ajaxError,
        ...
        return e && t && e != t ? i(core.pathThis(t)) ? ($.ajax({
            type: "POST",
            dataType: "json",
            url: "explorer.php?explorer/pathRname",
        ...
        if (!(1 > e.length)) {
            var a = e[0].path, i = LNG.remove_title, s = a + "<br/><br/>" + LNG.remove_info, o = "explorer.php?explorer/pathDelete";
            "*recycle*/" == G.this_path && (s = LNG.recycle_remove + "?", o = "explorer.php?explorer/pathDeleteRecycle", i = LNG.recycle_remove), "share" == e[0].type && (s = LNG.share_remove_tips, o = "explorer.php?userShare/del", i = LNG.share_remove), e.length > 1 && (s += ' ... <span class="badge">' + e.length + "</span>"), $.dialog({
        ...
        1 > e.length || $.ajax({
            url: "explorer.php?explorer/pathCopy",
            type: "POST",
            dataType: "json",
            data: n(e),
            error: core.ajaxError,
        ...
        1 > t.length || core.authCheck("userShare:set") && $.ajax({
            url: "./explorer.php?userShare/checkByPath&path=" + urlEncode(t),
            dataType: "json",
            success: function (e) {
        ...
        var o = function (e) {
            if ($(".share_setting_more").addClass("hidden"), void 0 == e)$(".share_has_url").addClass("hidden"), $(".share_action .share_remove_button").addClass("hidden"), $(".content_info input[name=sid]").val(""), $(".content_info input[name=type]").val(""), $(".content_info input[name=name]").val(""), $(".content_info input[name=path]").val(""), $(".content_info input[name=time_to]").val(""), $(".content_info input[name=share_password]").val(""), $(".share_view_info").addClass("hidden"); else {
                ...
                var n = G.app_host + "explorer.php?share/" + i + "&user=" + G.user_name + "&sid=" + e.sid;
            ...
            $(".share_action .share_remove_button").unbind("click").click(function () {
                ...
                $(".share_dialog .content_info input[name]").each(function () {
                    ...
                    url: "explorer.php?userShare/set",
                    data: e,
                    type: "POST",
                    dataType: "json",
                    beforeSend: function () {
        ...
        if (!(1 > e.length)) {
            ...
            FrameCall.father("ui.setWall", '"' + t + '"'), $.ajax({
                url: "explorer.php?setting/set&k=wall&v=" + urlEncode(t),
                type: "json",
                success: function (e) {
                    core.tips.tips(e)
                }
        ...
        if (!(1 > e.length)) {
            ...
            $.ajax({
                url: "./explorer.php?explorer/mkfile&path=" + o,
                type: "POST",
                dataType: "json",
        ...
        if (!(1 > e.length)) {
            ...
            $.ajax({
                url: "./explorer.php?explorer/mkfile&path=" + n,
                type: "POST",
                dataType: "json",
        ...
        1 > e.length || $.ajax({
            url: "explorer.php?explorer/pathCute",
            type: "POST",
            dataType: "json",
            data: n(e),
            error: core.ajaxError,
        ...
        if (e) {
            var a = "explorer.php?explorer/pathPast&path=" + urlEncode2(e);
            $.ajax({
        ...
        var a = "explorer.php?explorer/pathInfo";
        G.share_page !== void 0 && (a = "explorer.php?share/pathInfo&user=" + G.user + "&sid=" + G.sid), $.ajax({
            url: a,
            type: "POST",
            dataType: "json",
            data: n(e),
        ...
        i.unbind("hover click").bind("hover click", function () {
            ...
            $.ajax({
                url: "explorer.php?explorer/pathChmod&mod=" + e.val(),
                type: "POST",
                data: n(t),
                beforeSend: function () {
                    a.text(LNG.loading)
        ...
        if (core.authCheck("explorer:fileDownload") && !(1 > e.length)) {
            var t = "explorer.php?explorer/zipDownload";
            G.share_page !== void 0 && (t = "explorer.php?share/zipDownload&user=" + G.user + "&sid=" + G.sid), $.ajax({
                url: t,
                type: "POST",
                dataType: "json",
                data: n(e),
                ...
                success: function (e) {
                    ...
                    var t = "explorer.php?explorer/fileDownloadRemove&path=" + urlEncode2(e.info);
                    G.share_page !== void 0 && (t = "explorer.php?share/fileDownloadRemove&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e.info));
        ...
        if (e) {
            var a = "explorer.php?explorer/unzip&path=" + urlEncode2(e);
            $.ajax({
        ...
        t && $.ajax({
            url: "explorer.php?explorer/pathCuteDrag",
            type: "POST",
            dataType: "json",
        ...
        t && (void 0 == i && (i = 0), $.ajax({
            url: "explorer.php?explorer/pathCopyDrag",
            type: "POST",
            dataType: "json",
        ...
        $.ajax({
            url: "explorer.php?explorer/clipboard", dataType: "json", error: core.ajaxError, success: function (e) {
                ...
                name: LNG.button_save, focus: !0, callback: function () {
                    ...
                    switch (i) {
                        case"user_add":
                            ...
                            s = "./explorer.php?app/user_app&action=add&path=" + o;
                            break;
                        case"user_edit":
                            s = "./explorer.php?app/user_app&path=" + urlEncode2(t.path);
                            break;
                        case"root_add":
                            s = "./explorer.php?app/add&name=" + e.name;
                            break;
                        case"root_edit":
                            s = "./explorer.php?app/edit&name=" + e.name + "&old_name=" + t.name;
                            break;
                        default:
                    }
                    $.ajax({
        ...
        e && 4 > e.length && "http" != e.substring(0, 4) || $.ajax({
            url: "./explorer.php?app/get_url_title&url=" + e,
            dataType: "json",
            beforeSend: function () {
                core.tips.loading()
            },
            success: function (t) {
                ...
                e = "./explorer.php?app/user_app&action=add&path=" + n, $.ajax({
                    url: e,
                    type: "POST",
                    dataType: "json",
    ...
    var t = function (e, t) {
        ...
        if (core.authCheck("explorer:fileDownload", LNG.no_permission_download) && e) {
            var t = "explorer.php?explorer/fileDownload&path=" + urlEncode2(e);
            G.share_page !== void 0 && (t = "explorer.php?share/fileDownload&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e));
            var a = '<iframe src="' + t + '" style="width:0px;height:0px;border:0;" frameborder=0></iframe>' + LNG.download_ready + "...", i = $.dialog({
                icon: "succeed",
                title: !1,
                time: 1,
        ...
        if (core.authCheck("explorer:fileDownload", LNG.no_permission_download) && e) {
            ...
            if (void 0 == window.top.frames.OpenopenEditor) {
                var n = "./explorer.php?editor/edit&filename=" + urlEncode(urlEncode2(e));
                G.share_page !== void 0 && (n = "./explorer.php?share/edit&user=" + G.user + "&sid=" + G.sid + "&filename=" + urlEncode(urlEncode2(e)));
                var o = i + " ——" + LNG.edit;
        ...
        var t = "./explorer.php?explorer/officeView&path=" + urlEncode(e);
        if (G.share_page !== void 0)var t = G.app_host + "explorer.php?share/officeView&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e);
        art.dialog.open(t, {
            ico: core.ico("doc"),
...
define("app/src/explorer/path", ["../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer"], function (e) {
    ...
    var s = function (e, t, a) {
        ...
        $.ajax({
            dataType: "json", url: "explorer.php?explorer/historyBack", beforeSend: function () {
                $(".tools-left .msg").stop(!0, !0).fadeIn(100)
            }, error: core.ajaxError, success: function (e) {
        ...
        $.ajax({
            dataType: "json", url: "explorer.php?explorer/historyNext", beforeSend: function () {
                $(".tools-left .msg").stop(!0, !0).fadeIn(100)
            }, error: core.ajaxError, success: function (e) {
                return $(".tools-left .msg").fadeOut(100), e.code ? (e = e.data, G.this_path = e.thispath, G.json_data = e.list, Global.historyStatus = e.history_status, ui.f5(!1, !0), ui.header.updateHistoryStatus(), ui.header.addressSet(), void 0) : (core.tips.tips(e), $(Config.FileBoxSelector).html(""), !1)
            }
    ...
    return {
        ...
        share_open_window: function () {
            ...
            var i = "./explorer.php?share/" + a + "&user=" + G.user_name + "&sid=" + t.sid;
            window.open(i)
        },
        ...
        recycle_clear: function () {
            $.dialog({
                ...
                ok: function () {
                    $.ajax({
                        url: "explorer.php?explorer/pathDeleteRecycle", beforeSend: function () {
                            core.tips.loading()
                        }, error: core.ajaxError, success: function (e) {
        ...
        explorerNew: function () {
            window.open("explorer.php?/explorer&path=" + b().path)
        },
        openProject: function () {
