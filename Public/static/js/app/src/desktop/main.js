define("app/src/desktop/main", ["lib/jquery-lib", "lib/util", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "lib/picasa/picasa", "../../common/taskTap", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../common/rightMenu", "./fileSelect", "./ui", "../explorer/path", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer"], function (e) {
    ...
    return {
        filetype: {
            ...
            var a = G.app_host + "/explorer.php?explorer/fileProxy&path=" + urlEncode(e);
            return G.share_page !== void 0 && (a = G.app_host + "/explorer.php?share/fileProxy&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode(e)), a
            ...
            var t = "./explorer.php?editor/fileGet&filename=" + urlEncode2(e);
            G.share_page !== void 0 && (t = "./explorer.php?share/fileGet&user=" + G.user + "&sid=" + G.sid + "&filename=" + urlEncode2(e)), $.ajax({
                url: t,
                dataType: "json",
                beforeSend: function () {
            ...
            var t = "./explorer.php?/explorer&type=iframe&path=" + e;
            G.share_page !== void 0 && (t = "./explorer.php?share/folder&type=iframe&user=" + G.user + "&sid=" + G.sid + "&path=" + e), $.dialog.open(t, {
                resize: !0,
                fixed: !0,
                ico: core.ico("folder"),
                title: a,
            ...
            void 0 == e && (e = "");
            var a = "explorer.php?/editor&project=" + e;
            G.share_page !== void 0 && (a = "./explorer.php?share/code_read&user=" + G.user + "&sid=" + G.sid + "&project=" + e), $.dialog.open(a, {
                resize: !0,
                fixed: !0,
                ico: core.ico("folder"),
    ...
    var a = function () {
        ...
        0 != e && (G.sort_field = e, $(".menu_set_sort").removeClass("selected"), $(".set_sort_" + e).addClass("selected")), 0 != a && (G.sort_order = a, $(".menu_set_desc").removeClass("selected"), $(".set_sort_" + a).addClass("selected")), r(!1, !0), $.ajax({url: "explorer.php?setting/set&k=list_sort_field,list_sort_order&v=" + G.sort_field + "," + G.sort_order})
    }, n = function () {
        var e = 91;
    ...
    var o = function (e) {
        ...
        if (void 0 == e && (e = !0), void 0 == a && (a = !1), e)$.ajax({
            url: "explorer.php?explorer/pathList&type=desktop&path=" + G.this_path,
            dataType: "json",
            error: core.ajaxError,
            success: function (e) {
            ...
            url: "explorer.php?explorer/pathList&type=desktop&path=*recycle*/",
            dataType: "json",
            error: core.ajaxError,
            success: function (e) {
                if (!e.code)return !1;
    ...
    return {
        ...
        share_open_window: function () {
            ...
            var i = "./explorer.php?share/" + t + "&user=" + G.user_name + "&sid=" + a.sid;
            window.open(i)
        },
    ...
    var t = ["/", "\\", ":", "*", "?", '"', "<", ">", "|"], i = function (e) {
        ...
        if (!(1 > e.length)) {
            var t = e[0].path, i = LNG.remove_title, s = t + "<br/><br/>" + LNG.remove_info, o = "explorer.php?explorer/pathDelete";
        ...
        1 > a.length || core.authCheck("userShare:set") && $.ajax({
            url: "./explorer.php?userShare/checkByPath&path=" + urlEncode(a),
            dataType: "json",
            success: function (e) {
        ...
        if (!(1 > e.length)) {
            ...
            FrameCall.father("ui.setWall", '"' + a + '"'), $.ajax({
                url: "explorer.php?setting/set&k=wall&v=" + urlEncode(a),
                type: "json",
                success: function (e) {
                    core.tips.tips(e)
                }
        ...
        if (e) {
            var t = "explorer.php?explorer/pathPast&path=" + urlEncode2(e);
            $.ajax({
        ...
        var t = "explorer.php?explorer/pathInfo";
        G.share_page !== void 0 && (t = "explorer.php?share/pathInfo&user=" + G.user + "&sid=" + G.sid), $.ajax({
            url: t,
            type: "POST",
            dataType: "json",
            data: n(e),
        ...
        if (core.authCheck("explorer:fileDownload") && !(1 > e.length)) {
            var a = "explorer.php?explorer/zipDownload";
            G.share_page !== void 0 && (a = "explorer.php?share/zipDownload&user=" + G.user + "&sid=" + G.sid), $.ajax({
                url: a, type: "POST", dataType: "json", data: n(e), beforeSend: function () {
                    ...
                    var a = "explorer.php?explorer/fileDownloadRemove&path=" + urlEncode2(e.info);
                    G.share_page !== void 0 && (a = "explorer.php?share/fileDownloadRemove&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e.info));
        ...
        if (e) {
            var t = "explorer.php?explorer/unzip&path=" + urlEncode2(e);
            $.ajax({
                ...
                name: LNG.button_save, focus: !0, callback: function () {
                    ...
                    switch (i) {
                        case"user_add":
                            ...
                            break;
                        case"user_edit":
                            s = "./explorer.php?app/user_app&path=" + urlEncode2(a.path);
                            break;
                        case"root_add":
                            s = "./explorer.php?app/add&name=" + e.name;
                            break;
                        case"root_edit":
                            s = "./explorer.php?app/edit&name=" + e.name + "&old_name=" + a.name;
                            break;
                        default:
                    }
                    $.ajax({
    ...
    var a = function (e, a) {
        ...
        if (core.authCheck("explorer:fileDownload", LNG.no_permission_download) && e) {
            var a = "explorer.php?explorer/fileDownload&path=" + urlEncode2(e);
            G.share_page !== void 0 && (a = "explorer.php?share/fileDownload&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e));
            var t = '<iframe src="' + a + '" style="width:0px;height:0px;border:0;" frameborder=0></iframe>' + LNG.download_ready + "...", i = $.dialog({
                icon: "succeed",
                title: !1,
                time: 1,
        ...
        var a = "./explorer.php?explorer/officeView&path=" + urlEncode(e);
        if (G.share_page !== void 0)var a = G.app_host + "explorer.php?share/officeView&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e);
        art.dialog.open(a, {
            ico: core.ico("doc"),
