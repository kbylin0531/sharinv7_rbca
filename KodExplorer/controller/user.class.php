...
//            return ;
        }else if(!empty($_SESSION['kod_login']) and $_SESSION['kod_login']===true and $_SESSION['kod_user']['name']!=''){
...
//            return ;
        }else if(!empty($_COOKIE['kod_name']) and $_COOKIE['kod_name']!='' and $_COOKIE['kod_token']!=''){
            ...
            if ($this->config['setting_system']['auto_login'] != '1') {
                ...
                header('location:./explorer.php?user/loginSubmit&name=guest&password=guest');
            }
        }
        return false;
    }
    ...
    public function loginFirst(){
        ...
        header('location:./explorer.php?user/login');
        exit;
    }
    /**
     * 退出处理
